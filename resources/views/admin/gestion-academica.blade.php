...
@section('title', 'Gestión Academica')
            ...
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <div class="inline-flex items-center gap-2 rounded-full px-3 py-1 ring-1"
                        ...
                        <span class="text-xs font-semibold uppercase tracking-[0.18em] opacity-70">Academia</span>
                    </div>
                    ...
                    <p class="ui-muted mt-2 max-w-2xl text-sm leading-6">
                        Administra la gestión académica, docentes, materias, carreras, notas, asistencias y más.
                    </p>
                </div>
            </div>
        </section>
